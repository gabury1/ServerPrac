...
public class QUser extends EntityPathBase<User> {
    ...
    public final ListPath<Thread, SimplePath<Thread>> threads = this.<Thread, SimplePath<Thread>>createList("threads", Thread.class, SimplePath.class, PathInits.DIRECT2);
